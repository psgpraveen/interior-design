...
<header className='shadow-md font-sans tracking-wide relative z-50'>
    <section className='py-2 bg-[#007bff] text-white text-right px-10'>
      <p className='text-sm'><strong className="mx-3">Address:</strong>Plot No.25-A/G/4, Rd. No.12, Govandi, Mumbai-400 043<strong className="mx-3">Contact
          No:</strong>+91-9930503098 / +91-9022221616</p>
    </section>
    ...
    <div className='flex flex-wrap items-center justify-between gap-4 px-10 py-4 bg-white min-h-[70px]'>
      ...
      <div id="collapseMenu"
        ...
        <ul
          ...
          <li className='max-lg:border-b max-lg:py-3 px-3'><a href='#Feature'
              className='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>Feature</a>
          </li>
        
          <li className='max-lg:border-b max-lg:py-3 px-3'><a href='#intro'
          ...
          <Link to='/login' className='max-lg:border-b float-right max-lg:py-3 px-3'><a href='javascript:void(0)'
              className='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>Login</a>
          </Link>
